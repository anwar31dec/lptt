...
<?php if(count($items)) : ?>
    ...
    ?>
            ...
            <li><a href="<?php echo $item->link;?>"> <img src="<?php echo JURI::base(true).$resizer->resize(str_replace(JURI::base(true),'',$item->imageSmall),array('w'=>64,'h'=>64,'crop'=>true)); ?>" alt="<?php echo $item->title;?>" > <?php echo JHtml::_('string.truncate',$item->title,'50');?> <strong><?php echo JHtml::_('date',$item->created,'m/d/Y');?></strong></a></li>
