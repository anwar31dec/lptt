...
<div class="pesimg"> &nbsp; <strong>- <?php echo $name;?></strong> &nbsp;<i><?php echo $position;?></i> 
<?php if(!empty($avatar)):?>
<img src="<?php echo JURI::root(true).'/'.$avatar;?>" alt="<?php echo $name;?>" />
<?php elseif(!empty($email)): ?>
<img src="http://www.gravatar.com/avatar/<?php echo md5($email);?>?s=70&amp;d=<?php echo urlencode( JURI::root().'templates/'.JFactory::getApplication()->getTemplate().'/images/placeholder/user.png');?>" />
<?php endif;?>
</div>