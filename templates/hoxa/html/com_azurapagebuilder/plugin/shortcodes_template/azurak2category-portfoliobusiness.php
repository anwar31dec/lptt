                            ...
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <a href="<?php echo CthShortcodes::getK2ItemLink($item->id,$item->alias,$item->catid,$item->categoryalias);?>" class="cbp-l-caption-buttonLeft"><?php echo JText::_('TPL_HOXA_MORE_INFO_TEXT');?></a>
