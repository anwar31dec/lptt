	...
	<div class="content_fullwidth lessmar">
		...
		<div class="row">					
			<div class="col-md-7 col-sm-12 col-sx-12">
				<div class="panel panel-default">
					<div id="cparams-headerchart" class="panel-heading clearfix">
						
					</div>
					<div class="panel-body" style="height: auto; overflow: hidden;">
						<div class="clearfix list-panel" >
							<div id="wrap-line-chart">
								<div  id="stockoutstatuschart" style="height: auto; overflow: hidden;"></div>
							</div>
						</div>
					</div>
...
<script src='<?php echo $baseUrl; ?>/report_stockoutstatus.js'></script>
