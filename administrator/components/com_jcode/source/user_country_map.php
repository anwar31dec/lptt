	...
	<div class="col-md-6">		
			<div role="tabpanel"  style="margin-top:15px;">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#Country" aria-controls="Country" role="tab" data-toggle="tab"><?php echo $TEXT['Country List']; ?></a></li>
					<li role="presentation"><a href="#PGroup" aria-controls="PGroup" role="tab" data-toggle="tab"><?php echo $TEXT['Product Group List']; ?></a></li>
					<li role="presentation"><a href="#OwnerType" aria-controls="OwnerType" role="tab" data-toggle="tab"><?php echo $TEXT['Owner Type List']; ?></a></li>
					<li role="presentation"><a href="#Region" aria-controls="Region" role="tab" data-toggle="tab"><?php echo $TEXT['Region List']; ?></a></li>
				  </ul>
				  ...
				  <div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane" id="PGroup">						 
						 <div class="panel panel-default table-responsive" id="grid_productgroup">
							<div class="padding-md clearfix">       
								<table class="table table-striped table-bordered display table-hover" cellspacing="0" id="gridDataProductGroup">
									<thead>
										<tr>
											<th><?php echo $TEXT['Product Id']; ?></th>
											<th style="text-align:left;"><?php echo $TEXT['Product Group']; ?></th>
										</tr>
									</thead>
									<tbody></tbody>
								</table> 
					...
					<div role="tabpanel" class="tab-pane" id="OwnerType">						 
						 <div class="table table-striped table-bordered display table-hover" cellspacing="0" id="grid_ownertype">
							<div class="padding-md clearfix">       
								<table class="table table-striped display" id="gridDataOwnerType">
									<thead>
										<tr>
											<th>Owner Type Id</th>
					...
					<div role="tabpanel" class="tab-pane" id="Region">						 
						  <div class="panel panel-default table-responsive" id="grid_region">
							<div class="padding-md clearfix">       
								<table class="table table-striped table-bordered display table-hover" cellspacing="0" id="gridDataRegion">
									<thead>
										<tr>
											<th>Region Id</th>
											<th style="text-align:left;"><?php echo $TEXT['Region Name']; ?></th>
										</tr>
									</thead>
									<tbody></tbody>
								</table> 
...
<script src='<?php echo $baseUrl; ?>user_country_map.js'></script>
