	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="tbl-header1 pull-right">
				<label>
					<!-- <a class="btn-list" role="button" href="javascript:void(0);" onClick="onListPanel()"><i class="fa fa-chevron-left"></i><?php echo $TEXT['Back to List']; ?></a> -->
					<a data-mce-href="#" class="btn-list1 but_plus" href="javascript:void(0);" onClick="onListPanel()"><i data-mce-bootstrap="1" class="fa fa-reply fa-lg">&nbsp;</i> <?php echo $TEXT['Back to List']; ?></a>
					<!-- <a class="btn-form" role="button" href="javascript:void(0);" onClick="onFormPanel()"><?php //echo $TEXT['Add Record']; ?></a> -->
					<a data-mce-href="#" class="btn-form but_plus" href="javascript:void(0);" onClick="onFormPanel()"><i data-mce-bootstrap="1" class="fa fa-plus-square fa-lg">&nbsp;</i> <?php echo $TEXT['Add Record']; ?></a>
					<!-- <button class="btn btn-info" type="button" id="PrintBTN" onclick="print_function('print')"> <?php //echo $TEXT['Print']; ?> </button> -->
					<a id="PrintBTN" data-mce-href="#" class="but_hospital" href="javascript:void(0);" onclick="print_function('print')"><i data-mce-bootstrap="1" class="fa fa-print fa-lg">&nbsp;</i> <?php echo $TEXT['Print']; ?></a>
					<!-- <button class="btn btn-info" type="button" id="PrintBTN1" onclick="print_function('excel')" > <?php //echo $TEXT['Excel']; ?> </button> -->
					<a id="PrintBTN1" data-mce-href="#" class="but_coffe_cup" href="javascript:void(0);" onclick="print_function('excel')"><i data-mce-bootstrap="1" class="fa fa-file-excel-o fa-lg">&nbsp;</i> <?php echo $TEXT['Excel']; ?></a>
				</label>
			</div>
		</div>
	</div>
