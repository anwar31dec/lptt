...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="yearTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Year Id']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Year']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Year Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_year_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Year']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated numberinput" data-trigger="keyup" type="text" data-type="number" name="YearName" maxlength="4" id="YearName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateYearData" id="action" name="action" style="display: none;"/>
...
<script>
  function print_function(type) {
        var dataTableId = 'yearTable';
		var reportSaveName = 'yearList'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Year List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getYearData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getYearData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_year_form select, #t_year_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_year.js'></script>
