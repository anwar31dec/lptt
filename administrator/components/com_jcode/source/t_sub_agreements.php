...
<div class="nav-data">
	<div class="row">					
		<div class="col-md-6 col-padding">					
			<div class="tbl-header1" id="agreementTable_length1">
				<label><?php echo $TEXT['Product Group']; ?>
					<select class="form-control" name="item-group" id="item-group">
...
<div class="row"> 
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="agreementTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['AgreementId']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Product Group']; ?></th>
                        <th><?php echo $TEXT['Funding Source']; ?></th>
                        <th><?php echo $TEXT['Agreement Name']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Sub-agreements Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="agreement_form" class="form-horizontal form-border no-margin">
	
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemGroup"><?php echo $TEXT['Product Group']; ?>*</label>
	                    <div class="col-md-8">
	                        <select class="form-control" name="ItemGroup" id="ItemGroup" data-required="true" ></select>
	                    </div>
	                </div>
					
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="FundingSourceId"><?php echo $TEXT['Funding Source']; ?>*</label>
	                    <div class="col-md-8">
	                        <select class="form-control" name="FundingSourceId" id="FundingSourceId" data-required="true" ></select>
	                    </div>
	                </div>

	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Agreement Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="AgreementName" id="AgreementName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateAgreementData" id="action" name="action" style="display: none;"/>
...
<script>
    ...
    function print_function(type) {
        var dataTableId = 'agreementTable';
		var reportSaveName = 'Sub_agreements_List'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Sub-agreements'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getAgreementData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getAgreementData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#agreement_form select, #agreement_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_sub_agreements.js'></script>
