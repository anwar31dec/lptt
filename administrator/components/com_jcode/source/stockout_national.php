...
<div class="page-title">	
	<h3 class="no-margin">Stock out at national level</h3>
	<span>Stock out at national level by country</span>
</div>
		...
		<div id="cparams-panel" class="panel panel-default">	
			...
			<div class="panel-body">		
				<div class="clearfix list-panel" >
					<table class="table table-striped" id="tbl-stockout-national">
						<thead>
							<tr>		
								<th>Id</th>	
...
<link href="<?php echo $baseUrl; ?>/stockout_national.css" rel="stylesheet">
<script src='<?php echo $baseUrl; ?>/stockout_national.js'></script>
