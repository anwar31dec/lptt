...
$jBaseUrl = $_GET['jBaseUrl']; 
    $sWhere = "";
	if ($_GET['curSearch'] != "") {
		$sWhere = " WHERE  (FTypeName LIKE '%" . mysql_real_escape_string($_GET['curSearch']) . "%') ";
	}

    $sql=" SELECT  FTypeId,FTypeName	
		   FROM t_facility_type".$sWhere." order by FTypeName" ;
