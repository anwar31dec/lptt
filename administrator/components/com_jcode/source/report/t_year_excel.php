...
$jBaseUrl = $_GET['jBaseUrl'];
    ...
    $sWhere = "";
    if ($_GET['curSearch'] != "") {
        $sWhere = " WHERE  (YearName LIKE '%" . mysql_real_escape_string($_GET['curSearch']) . "%') ";
    }
		 
	$sql=" SELECT YearID,YearName
	       FROM t_year". $sWhere." order by YearName ";
    ...
    if ($total>0){
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('A2',$gTEXT['Year List'])	;
	...
	$file = 'Year_List_'.$exportTime. '.xlsx';
