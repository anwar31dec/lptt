...
$jBaseUrl = $_GET['jBaseUrl']; 
 	  ...
 	  $sWhere = "";
	  if ($_GET['curSearch'] != "") {
		$sWhere = " WHERE  (ServiceTypeName LIKE '%" . mysql_real_escape_string($_GET['curSearch']) . "%') ";
	  }
	...
	mysql_query("SET character_set_results=utf8");   
      ...
      if ($total>0){
            ...
            $objPHPExcel->getActiveSheet()->SetCellValue('A2',$gTEXT['Service Type List'] )	;
            ...
            $objPHPExcel->getActiveSheet()
            					->SetCellValue('A6', 'SL#')							
            					->SetCellValue('B6',$gTEXT['Service Type'] )
								->SetCellValue('C6',$gTEXT['Service Type (French)']);
            ...
            while($rec=mysql_fetch_array($r)){
                ...
                $objPHPExcel->getActiveSheet()
                						->SetCellValue('A'.$j, $i)							
                						->SetCellValue('B'.$j, $rec['ServiceTypeName'])
										->SetCellValue('C'.$j, $rec['ServiceTypeNameFrench']);  
	...
	$file = 'Service_Type_'.$exportTime. '.xlsx';
