...
<div class="page-title">
	...
	<h3 class="no-margin">Patient Overview</h3><br />
...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class="clearfix list-panel" >
			<table class="table table-striped" id="POMasterTable">
				<thead>
					<tr>
						<th>PO Id</th>
		...
		<div class="clearfix form-panel" >
			...
			<form novalidate="" data-validate="parsley" id="t_POMaster_form" class="form-horizontal form-border no-margin">	
            							
				<div class="form-group">
					<label class="control-label col-lg-3">Patient Overview</label>
					<div class="col-lg-9">
                        <input class="form-control input-sm parsley-validated" type="text" name="POMasterName" id="POMasterName" data-required="true" placeholder="input here..."/>							
					</div>
				</div>
			               
				<div class="form-group">				
					<input type="text" style="display:none;" value="insertUpdatePOMasterTableData" id="action" name="action"/>
...
function printfunction()
{
	...
	window.open("http://softworks02/warp/administrator/components/com_jcode/source/report/printProcessing.php?baseUrl="+baseUrl+"&action=getPOMasterData");			 
...
<script src='<?php echo $baseUrl; ?>t_patient_overview.js'></script>
