...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="ItemTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Product Id']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Product Group Name']; ?></th>
                        <th><?php echo $TEXT['Product Group Name (French)']; ?></th>
                        <th ><?php echo $TEXT['Patient Info']; ?></th>
	        ...
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_item_form" class="form-horizontal form-border no-margin">
	                ...
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="GroupName"><?php echo $TEXT['Product Group Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="GroupName" id="GroupName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="GroupNameFrench"><?php echo $TEXT['Product Group Name (French)']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="GroupNameFrench" id="GroupNameFrench" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="CommonBasket"><?php echo $TEXT['Patient Info']; ?></label>
	                    <div class="col-md-8">
	                        <input type="checkbox" name="bPatientInfo" id="bPatientInfo" onclick="bPatient()"/>
	                ...
	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateItemData" id="action" name="action" style="display: none;"/>
...
<script>
    function print_function(type) {
		...
		var reportSaveName = 'Product_Groups'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Product Groups List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getItemData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getItemData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_item_form select, #t_item_form input{
		max-width: 300px;
	}
</style>
