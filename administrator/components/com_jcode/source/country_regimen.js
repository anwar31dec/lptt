                ...
                $(this).click(function() {
                    ...
                    $.ajax({
                        ...
                        "success": function(response) {
                            ...
                            var regimenttData = JSON.parse(response)['aaData'];

                            if (regimenttData.t_country_regimen != undefined) {
                                var retCountryRegimenId = regimenttData.t_country_regimen[0][0];
                                oTable_regimen.fnUpdate(retCountryRegimenId, nTr, 0, false, false);
                            } else if (regimenttData.length == 0) {
                                oTable_regimen.fnUpdate('', nTr, 0, false, false);
                            }
