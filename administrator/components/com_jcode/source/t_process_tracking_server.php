	...
	switch ($ProcessId) {
		...
		case 8:
			...
			if($ParentProcessId){
				...
				if ($ProTrackId) {
					$sql2 = "UPDATE t_process_tracking SET OutTime = NOW(), Duration = $duration, TxtDuration = '$txtDuration', OutUserId = '$jUserId', ParentNoOfScann = $ParentNoOfScann WHERE ProTrackId = $ProTrackId;";
