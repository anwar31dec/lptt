...
<div class="row"> 
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="SStatusTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Shipment Id']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Shipment Status Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_shipment_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="SStatusDesc"><?php echo $TEXT['Shipment Status']; ?></label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" type="text" maxlength="100" name="SStatusDesc" id="SStatusDesc" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateSStatusData" id="action" name="action" style="display: none;"/>
...
<script>
 function print_function(type) {
        var dataTableId = 'SStatusTable';
		var reportSaveName = 'Shipment_Status_List'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Shipment Status List'];
       ...
       reportSaveName = reportSaveName+'_'+today;
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getSStatusData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getSStatusData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_shipment_form select, #t_shipment_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_shipmentstatus.js'></script>
