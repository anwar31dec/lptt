...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="AdjustReasonTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['AdjustReasonId']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Adjust Reason']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Adjust Reason Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_Adjust_Reason_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Adjust Reason']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="AdjustReason" id="AdjustReason" data-required="true" placeholder="input here..." />
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateAdjustReasonData" id="action" name="action" style="display: none;"/>
		                    <input type="text" id="AdjustId" name="AdjustId" style="display: none;"/>
...
<script>
    function print_function(type) {
        var dataTableId = 'AdjustReasonTable';
		var reportSaveName = 'Stock_Adjustment_Reasons'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Stock Adjustment Reasons List'];
       ...
       reportSaveName = reportSaveName+'_'+today;
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getAdjustReasonData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getAdjustReasonData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_Adjust_Reason_form select, #t_Adjust_Reason_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_adjust_reason.js'></script>
