...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="ProductSubGroupTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Product SubGroup Id']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Product Subgroup Name']; ?></th>
                        <th style="text-align: center;"><?php echo $TEXT['Action']; ?></th>
                        <th><?php echo $TEXT['ItemGroupId']; ?></th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>			                   
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Product Subgroup Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="ProductSubGroup_form" class="form-horizontal form-border no-margin">
	                ...
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ProductSubGroupName"><?php echo $TEXT['Product Subgroup Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="ProductSubGroupName" id="ProductSubGroupName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateProductSubGroupData" id="action" name="action" style="display: none;"/>
...
<script>
 function print_function(type){
	var dataTableId = 'ProductSubGroupTable';
	var reportSaveName = 'Product_Subgroups'; //Not allow any type of special character of cahrtName
	...
	var reportHeaderName = TEXT['Product Subgroups List'];
  ...
  if(type == 'print'){	 
		window.open("<?php echo $baseUrl;?>report/print_master.php?action=getProductSubGroupData"
		...
		window.open("<?php echo $baseUrl;?>report/excel_master.php?action=getProductSubGroupData"
		+"&jBaseUrl=<?php	echo $jBaseUrl; ?>"
		+"&lan=<?php echo $lan;?>"
		+"&reportSaveName="+reportSaveName 
		+"&sSearch="+currentSearch 
...
<style>
	#ProductSubGroup_form select, #ProductSubGroup_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_product_subgroup.js'></script>
