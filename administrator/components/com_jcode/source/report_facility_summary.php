		...
		<div class="row">
			...
			<div id="cparams-panel" class="panel panel-default">
				<div class="panel-heading clearfix">
					<?php echo $TEXT['Stock Balance Report by Region/District']; ?>
...
function print_function(type){
	...
	var reportSaveName = 'Facility_Stock_Summary'; //Not allow any type of special character of cahrtName
	var reportHeaderList = new Array();
	var dataAlignment = new Array();
	var cellWidth = new Array();
	var chart = 1;
	
	var reportHeaderName = TEXT['Stock Balance Report by Region/District'];
	reportHeaderList[0] = reportHeaderName;
	reportHeaderList[1] = $('#country-list').find(":selected").text() +' - '+$('#Region-list').find(":selected").text() +' - '+$('#District-list').find(":selected").text() +' - '+ $('#item-group').find(":selected").text() +' - '+$('#report-by').find(":selected").text();
...
<script src='<?php echo $baseUrl; ?>report_facility_summary.js'></script>
