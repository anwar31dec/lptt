...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="OwnerTypeTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th>Owner Type Id</th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Owner Type Name']; ?></th>
                        <th><?php echo $TEXT['Owner Type Name(French)']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Owner Type Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_Owner_Type_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4"><?php echo $TEXT['Owner Type Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="OwnerTypeName" id="OwnerTypeName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-md-4"><?php echo $TEXT['Owner Type Name(French)']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="150" type="text" name="OwnerTypeNameFrench" id="OwnerTypeNameFrench" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
					
	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateOwnerTypeData" id="action" name="action" style="display: none;"/>
...
<script>
    ...
    function print_function(type) {
        var dataTableId = 'OwnerTypeTable';
		var reportSaveName = 'OwnerType'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Owner Type List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getOwnerTypeData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getOwnerTypeData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_Owner_Type_form select, #t_Owner_Type_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_owner_type.js'></script>
