...
<div class="row"> 
	<div class="col-md-12">		
		<div id="list-panel">
            <table  id="ProcuringAgentsTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Procuring Agents Id']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Procuring Agents']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Procuring Agents Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_procurement_agents_form" class="form-horizontal form-border no-margin">
	
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Procuring Agent']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="50" type="text" name="PAgencyName" id="PAgencyName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateProcuringAgentsData" id="action" name="action" style="display: none;"/>
...
<script>
    function print_function(type) {
        var dataTableId = 'ProcuringAgentsTable';
		var reportSaveName = 'Procuring_Agents'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Procuring Agents List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getProcuringAgentsData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getProcuringAgentsData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_procurement_agents_form select, #t_procurement_agents_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_procurement_agents.js'></script>
