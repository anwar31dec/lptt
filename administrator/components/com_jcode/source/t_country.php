...
<div class="row"> 
	<div class="col-md-12">
		<div id="list-panel">
                <table  id="CountryFormTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                    <thead>
						<tr>
							<th><?php echo $TEXT['Country Id']; ?></th>
							<th style="text-align: center;">SL.</th>
							<th><?php echo $TEXT['Country Code']; ?></th>
							<th><?php echo $TEXT['Country Name']; ?></th>
							<th><?php echo $TEXT['Country Name (French)']; ?></th>
							<th><?php echo $TEXT['Country Level']; ?></th>
							<th><?php echo $TEXT['Start Month']; ?></th>
							<th><?php echo $TEXT['Center']; ?></th>
							<th><?php echo $TEXT['Zoom Level']; ?></th>
            ...
            <div id="form-panel">
		        <div class="panel-heading">
		            <?php echo $TEXT['Country Form']; ?>           
		        </div>
		        <div class="panel-body">
		            <form novalidate="" data-validate="parsley" id="t_country_form" class="form-horizontal form-border no-margin">
		
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="CountryCode"><?php echo $TEXT['Country Code']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" type="text" name="CountryCode" id="CountryCode" data-required="true" maxlength="3"  placeholder="input here..."/>
		                    </div>
		                </div>
		
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="CountryName"><?php echo $TEXT['Country Name']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" type="text" name="CountryName" id="CountryName" maxlength="80" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
		
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="CountryNameFrench"><?php echo $TEXT['Country Name (French)']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="CountryNameFrench" id="CountryNameFrench" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
		
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="CenterLat"><?php echo $TEXT['Center latitude']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm numberinput parsley-validated" type="text" data-trigger="keyup" name="CenterLat" id="CenterLat"  data-required="true" data-type="number" placeholder="input here..."/>
		                    </div>
		                </div>
		
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="ShortName"><?php echo $TEXT['Center longitude']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm numberinput parsley-validated" type="text" data-trigger="keyup" name="CenterLong" id="CenterLong" data-required="true" data-type="number" placeholder="input here..."/>
		                    </div>
		                </div>
						
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="ZoomLevel"><?php echo $TEXT['Zoom Level']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm numberinput parsley-validated" type="text" name="ZoomLevel" data-type="number" id="ZoomLevel" data-trigger="keyup" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
		                
						
                        <div class="form-group">
                            <label class="control-label col-md-4"><?php echo $TEXT['Level Type']; ?></label>
                            <div class="col-md-8">
                                <label class="label-radio">
                                    <input type="radio" name="levelType" id="levelType1" value="0" onclick="checkNational()"/><span class="custom-radio"></span>
                                    <?php echo $TEXT['National']; ?>
                                </label>
                                <label class="label-radio">
                                    <input type="radio" name="levelType" id="levelType2" value="1" onclick="checkFacility()"/><span class="custom-radio"></span>
                                    <?php echo $TEXT['Facility']; ?>
                                </label>
                            </div>
                        </div>
		                ...
		                <div class="form-group">
		                	<div class="col-md-4">
			                    <input type="text" value="insertUpdateCountryData" id="action" name="action" style="display: none;"/>
	...
	<script>
		 function print_function(type) {
			var dataTableId = 'CountryFormTable';
			var reportSaveName = 'Countries'; //Not allow any type of special character of cahrtName
			...
			var reportHeaderName = TEXT['Country List'];
			reportHeaderList[0] = reportHeaderName;
			//reportHeaderList[1] = 'Product Group: ' + $('#item-group option[value='+$('#item-group').val()+']').text();
			...
			if (type == 'print') {
				window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getCountryData"
				...
				window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getCountryData"
						+ "&jBaseUrl=<?php echo $jBaseUrl; ?>"
						+ "&lan=<?php echo $lan; ?>"
						+ "&reportSaveName=" + reportSaveName
						+ "&sSearch=" + currentSearch
...
<style>
	#t_country_form select, #t_country_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_country.js'></script>
