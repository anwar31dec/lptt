...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="ReportByTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Report By Name']; ?></th>
                        <th><?php echo $TEXT['Report By Name(French)']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Report By Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_reportby_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4"><?php echo $TEXT['Report By Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" type="text" name="OwnerTypeName" maxlength="100" id="OwnerTypeName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-md-4"><?php echo $TEXT['Report By Name(French)']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" type="text" name="OwnerTypeNameFrench" maxlength="150" id="OwnerTypeNameFrench" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
					
	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateReportByData" id="action" name="action" style="display: none;"/>
...
<script>
  ...
  function print_function(type){
	var dataTableId = 'ReportByTable';
	var reportSaveName = 'ReportBy'; //Not allow any type of special character of cahrtName
	...
	var reportHeaderName = TEXT['Report By List'];
  ...
  if(type == 'print'){	 
		window.open("<?php echo $baseUrl;?>report/print_master.php?action=getReportingByData"
		...
		window.open("<?php echo $baseUrl;?>report/excel_master.php?action=getReportingByData"
		+"&jBaseUrl=<?php	echo $jBaseUrl; ?>"
		+"&lan=<?php echo $lan;?>"
		+"&reportSaveName="+reportSaveName 
		+"&sSearch="+currentSearch 
...
<style>
	#t_reportby_form select, #t_reportby_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_reportby.js'></script>
