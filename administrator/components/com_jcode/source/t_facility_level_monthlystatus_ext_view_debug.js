...
Ext.onReady(function() {
	...
	function savePatientOverview(oGrid_event) {
		...
		Ext.Ajax.request({
			waitMsg : 'Please wait...',
			url : baseUrl + 't_facility_level_monthlystatus_ext_view_server.php',
			params : {
	...
	function saveTheCell(oGrid_event) {
		...
		case "ClStock_A":
			...
			if (pFacilityCount == 0) {
				...
				oGrid_event.record.set("MaxQty", vAMC * MxFactor);
	...
	gridArvData = new Ext.grid.EditorGridPanel({
		...
		columns : [{
			...
			tooltip : TEXT['Maximum Quantity'] + " -> (H=F*2)",
			width : 70,
			align : 'right',
			dataIndex : 'MaxQty',
			sortable : false,
	...
	function printHtml() {
		...
		window.open(baseUrl + "report/t_facility_data_entry_print.php?jBaseUrl=" + jBaseUrl + "&CFMStockId=" + pReportId + "&CountryId=" + pCountryId + "&RegionId=" + pRegionId + "&DistrictId=" + pDistrictId + "&OwnerTypeId=" + pOwnerTypeId + "&MonthId=" + pMonthId + "&YearId=" + pYearId + "&FacilityId=" + pFacilityId + "&lan=" + lan);
	}
	...
	function printExcel() {
		...
		window.open(baseUrl + "report/t_facility_data_entry_excel.php?jBaseUrl=" + jBaseUrl + "&CFMStockId=" + pReportId + "&CountryId=" + pCountryId + "&RegionId=" + pRegionId + "&DistrictId=" + pDistrictId + "&OwnerTypeId=" + pOwnerTypeId + "&MonthId=" + pMonthId + "&YearId=" + pYearId + "&FacilityId=" + pFacilityId + "&lan=" + lan);
	}
