...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="dataTables_length" id="itemTable_length">
				<label>Show
					<select name="itemTable_length" aria-controls="itemTable" class="form-control input-sm">
						<option value="25">25</option><option value="50">50</option><option value="100">100</option>
					</select> entries</label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="dataTables_length2" id="itemTable_length2">
				<label>Show
					<select name="itemTable_length" aria-controls="itemTable" class="form-control input-sm">
						<option value="25">25</option><option value="50">50</option><option value="100">100</option>
					</select> entries</label>
