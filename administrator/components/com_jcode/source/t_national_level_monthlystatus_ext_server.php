...
// function insertIntoStockData($value='')
// {
	// $sql1 = "INSERT INTO t_cnm_patientoverview (CNMStockId, FormulationId, CountryId, MonthId, Year, RefillPatient, NewPatient, TotalPatient, ItemGroupId) "
...
function insertIntoStockData() {
	...
	try 
	{
		...
		$sql1 = "INSERT INTO t_cnm_patientoverview (CNMStockId, FormulationId, CountryId, MonthId, Year, RefillPatient, NewPatient, TotalPatient, ItemGroupId) "
			. "SELECT $reportId, a.FormulationId, ".$_POST['pCountryId'].", " . $monthId.",'" . $year ."',". " 0, 0, 0, ItemGroupId FROM t_formulation a WHERE ItemGroupId = " . $_POST['pItemGroupId'];	
	
		$result1 = mysql_query($sql1);
		$error = mysql_error()."</br>";
	
		$sql2 = "INSERT INTO "."t_cnm_regimenpatient"." (CNMStockId, RegimenId, CountryId, MonthId, Year, RefillPatient, NewPatient, TotalPatient, ItemGroupId) "
			. "SELECT $reportId, RegimenId, " . " CountryId, " . $monthId.",'" . $year ."',". " 0, 0, 0, ItemGroupId FROM t_country_regimen WHERE CountryId = " . $_POST['pCountryId'] . " AND ItemGroupId = " . $_POST['pItemGroupId'];
...
function  delete_data_from_yyyy() {	
	...
	$sql1 .= " WHERE MonthId = " . $monthId. " and Year = '" . $year ."' AND CountryId = " . $_POST['pCountryId'] . " and ItemGroupId = " . $_POST['pItemGroupId'];
			
	$sql2 = "DELETE FROM "."t_cnm_regimenpatient";	
	$sql2 .= " WHERE MonthId = " . $monthId. " and Year = '" . $year ."' AND CountryId = " . $_POST['pCountryId'] . " and ItemGroupId = " . $_POST['pItemGroupId'];
