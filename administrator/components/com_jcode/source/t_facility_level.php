...
<div class="row"> 
	<div class="col-md-12">
		<div id="list-panel">
                <table  id="FacilityLevelTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                    <thead>
                        <tr>
							<th>Facility Level Id</th>
							<th style="text-align: center;">SL.</th>
							<th><?php echo $TEXT['Facility Level']; ?></th>
							<th><?php echo $TEXT['Facility Level (French)']; ?></th>
            ...
            <div id="form-panel">
		        <div class="panel-heading">
		            <?php echo $TEXT['Facility Level Form']; ?>           
		        </div>
		        <div class="panel-body">
		            <form novalidate="" data-validate="parsley" id="t_facility_level_form" class="form-horizontal form-border no-margin">

		                <div class="form-group">
		                    <label class="control-label col-md-4" for="FLevelName"><?php echo $TEXT['Facility Level']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" maxlength="50" type="text" name="FLevelName" id="FLevelName" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="FLevelNameFrench"><?php echo $TEXT['Facility Level (French)']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" maxlength="60" type="text" name="FLevelNameFrench" id="FLevelNameFrench" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div id="colorpicker3" class="input-group colorpicker-component colorpicker-element">
									<input class="form-control" type="text" name="ColorCode" id="ColorCode" ischeck = "true" display-name="Color Code" data-required="true" placeholder="input here..." maxlength="50"/>
		                ...
		                <div class="form-group">
		                	<div class="col-md-4">
			                    <input type="text" value="insertUpdateFacilityLevelData" id="action" name="action" style="display: none;"/>
 ...
 function print_function(type){
	var dataTableId = 'FacilityLevelTable';
	var reportSaveName = 'Facility_Levels'; //Not allow any type of special character of cahrtName
	...
	var reportHeaderName = TEXT['Facility Levels List'];
  ...
  if(type == 'print'){	 
		window.open("<?php echo $baseUrl;?>report/print_master.php?action=getFacilityLevelData"
		...
		window.open("<?php echo $baseUrl;?>report/excel_master.php?action=getFacilityLevelData"
		+"&jBaseUrl=<?php	echo $jBaseUrl; ?>"
		+"&lan=<?php echo $lan;?>"
		+"&reportSaveName="+reportSaveName 
		+"&sSearch="+currentSearch 
...
<style>
	#t_facility_level_form select, #t_facility_level_form input, #colorpicker3 input-group{
		max-width: 300px;
	}
	#colorpicker3 {
		max-width: 300px;
...
<script src='<?php echo $baseUrl; ?>t_facility_level.js'></script>
