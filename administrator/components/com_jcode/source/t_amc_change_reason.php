...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="amcChangereasonTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['AMC Change Reason Id']; ?></th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['AMC Change Reason Name']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['AMC Change Reason Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_amc_change_reason" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['AMC Change Reason']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="50" type="text"  name="AmcChangeReasonName" id="AmcChangeReasonName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateAmcChangeReasonData" id="action" name="action" style="display: none;"/>
...
<script>
  function print_function(type) {
        var dataTableId = 'amcChangereasonTable';
		var reportSaveName = 'AMC_Change_Reasons'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['AMC Change Reasons List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getAmcChangeReasonData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getAmcChangeReasonData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_amc_change_reason select, #t_amc_change_reason input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_amc_change_reason.js'></script>
