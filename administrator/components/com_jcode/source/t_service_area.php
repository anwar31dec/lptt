...
<div class="row"> 
	...
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="ServiceAreaTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th>Service Area Id</th>
                        <th style="text-align: center;">SL.</th>
                        <th><?php echo $TEXT['Service Area Name']; ?></th>
                        <th><?php echo $TEXT['Service Area Name (French)']; ?></th>
        ...
        <div id="form-panel">
	        <div class="panel-heading">
	            <?php echo $TEXT['Service Area Form']; ?>           
	        </div>
	        <div class="panel-body">
	            <form novalidate="" data-validate="parsley" id="t_Service_Area_form" class="form-horizontal form-border no-margin">
				
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Service Area Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="ServiceAreaName" id="ServiceAreaName" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Service Area Name (French)']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" maxlength="150" type="text" name="ServiceAreaNameFrench" id="ServiceAreaNameFrench" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>
					
	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateServiceAreaData" id="action" name="action" style="display: none;"/>
...
<script>
    ...
    function print_function(type) {
        var dataTableId = 'ServiceAreaTable';
		var reportSaveName = 'ServiceArea'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Service Area'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getServiceAreaData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getServiceAreaData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#t_Service_Area_form select, #t_Service_Area_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_service_area.js'></script>
