...
//    }, 500, function () {
    ...
    $.ajax({
        type: "POST",
        url: baseUrl + "report_every_process_summary_ana_server.php",
        data: {
        ...
        success: function (results) {
            ...
            everyProcessSummary = $('#tbl-every-process-summary').dataTable({
                ...
                "iDisplayLength": 25,
                "sAjaxSource": baseUrl + "report_every_process_summary_ana_server.php",
...
$(function () {
    ...
    $.each(gProcessListAna, function (i, obj) {
