...
?>
<div class="row row-margin" id="entry_panel">
...
<div class="row row-margin" id="row-facility-groupmap-grid">

    <div class="panel panel-default table-responsive">
        <div class="panel-heading page-title">
            Assinged Group List
        <a class="btn btn-primary btn-small pull-right btn-form2 fa" role="button" href="javascript:void(0);" onClick="onFormPanelFacilityGroupMap()" style="margin-left:4px;"><?php echo $TEXT['Add Record']; ?></a>	              

        </div>
        <div class="padding-md clearfix">
            <table id="tbl-facility-group-map" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th style="text-align:center;">SL#</th>
                        <th>FacilityServiceId</th>
                        <th>FacilityId</th>
                        <th>ItemGroupId</th>
                        <th>Product Group</th>
                        <th>StartMonthId</th>
...
<div class="row row-margin" id="row-facility-groupmap-entry">

    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Assinged Group Form
                <a id="facility-group-map-back-to-list" class="btn btn-warning btn-small pull-right btn-list" role="button" href="javascript:void(0);" onClick="onListPanelFacilityGroupMap()" style="margin-left:4px;"><i class="fa fa-chevron-left"></i>&nbsp;<?php echo $TEXT['Back to List']; ?></a>

            </div>	

            <div class="panel-body">

                <form class="no-margin" data-validate="parsley" id="frm-facility-groupmap">                
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Product Group*</label>
                                <select class="form-control input-sm" id="ItemGroupId" name="ItemGroupId" data-required="true" placeholder="Product Group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Supply From</label>
                                <select class="form-control input-sm" name="SupplyFrom" id="SupplyFrom">
                                    <option value="" selected="true">Select</option>
                                </select>
                            </div>
                        </div>							
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="StartMonthId" name="StartMonthId" data-required="true" placeholder="Start Month">
                                    <option value="" selected="true">Select</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="StartYearId" name="StartYearId" data-required="true" placeholder="Start Year">
                                    <option value="" selected="true">Select</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer text-right">
                        <input type="hidden"  value="insertUpdateFacilityGroupMap" id="action" name="action"/>                        
                        <input type="text" id="FacilityServiceId" name="FacilityServiceId" style="display:none"/>
                        <input type="text" id="FacilityId" name="FacilityId" style="display:none"/>		
                           <input type="hidden" id="userId" value="<?php echo $user->name; ?>"/>
                        <input type="hidden" id="en-GBId" value="<?php echo $lan; ?>"/>
                        <a id="btn-submit-facility-groupmap" href="javascript:void(0);" class="btn btn-success btn-form-success">Submit</a>
                        <a id="btn-cancel-facility-groupmap" href="javascript:void(0);" class="btn btn-default" onClick="onListPanelFacilityGroupMap()">Cancel</a>					
                    </div>
...
<script>
    function print_function() {
		...
		//var pCountryName = $('#ACountryId').find(":selected").text();
        //var pRegionName =$('#ARegionId').find(":selected").text();
        //var FTypeName =$('#AFTypeId').find(":selected").text();
        //var FLevelName =$('#AFLevelId').find(":selected").text();
...
<script src='<?php echo $baseUrl; ?>t_facility.js'></script>
