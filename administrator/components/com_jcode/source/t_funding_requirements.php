...
<div class="page-title">
	...
	<h3 class="no-margin"><?php echo $TEXT['Funding Requirements Entry']; ?></h3></br>
</div>
...
<div class="row" id="form-panel">
    <div class="panel panel-default">
        <div class="panel-heading">
            <?php echo $TEXT['Funding Requirements Source Form']; ?>    
        </div>
	    <div class="panel-body">
...
<script src='<?php echo $baseUrl; ?>t_funding_requirements.js'></script>
