		...
		<div class="nav-data">
			<div class="row columns">				
				<div class="col-md-6 col-padding">					
					<div class="tbl-header1" id="regionTable_length1">
...
<div class="row"> 
	<div class="col-md-12">
		...
		<div id="list-panel">
            <table  id="regionTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                <thead>
                    <tr>
                        <th><?php echo $TEXT['Region Id']; ?></th>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-8">
	                        <select class="form-control" name="CountryId" id="CountryId" data-required="true" >
	                            <option selected="true" value=""><?php echo $TEXT['Select Country']; ?></option></select>
	                    </div>
	                </div>

	                <div class="form-group">
	                    <label class="control-label col-md-4" for="ItemCode"><?php echo $TEXT['Region Name']; ?>*</label>
	                    <div class="col-md-8">
	                        <input class="form-control input-sm parsley-validated" type="text" name="RegionName" id="RegionName" maxlength="100" data-required="true" placeholder="input here..."/>
	                    </div>
	                </div>

	                <div class="form-group">
	                	<div class="col-md-4">
		                    <input type="text" value="insertUpdateRegionData" id="action" name="action" style="display: none;"/>
...
<script>
    function print_function(type) {
        var dataTableId = 'regionTable';
		var reportSaveName = 'Country_Regions'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Country Regions List'];
        //'Case Type Master List';
        reportHeaderList[0] = reportHeaderName;
        reportHeaderList[1] = TEXT['Country'] + ': ' + $('#AllCountryId option[value=' + $('#AllCountryId').val() + ']').text();
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getCountryRegionsData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getCountryRegionsData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#region_form select, #region_form input{
		max-width: 300px;
	}
</style>
...
<script src='<?php echo $baseUrl; ?>t_region.js'></script>
