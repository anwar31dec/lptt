        ...
        <table  id="tblProcessCount" class="table table-striped table-bordered display table-hover" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:20%"><?php echo 'Total In'; ?></th>
                    <th style="width:20%"><?php echo 'Total Out'; ?></th>
                    <th style="width:20%"><?php echo 'Total Pending'; ?></th>
                </tr>
            </thead>
            <tbody>	</tbody>
        </table>
...
<script src='<?php echo $baseUrl; ?>report_analytical_process_summary.js'></script>
