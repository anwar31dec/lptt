...
//=====================================================Shipment Report Table=======================================================
	...
	$sql = "SELECT SQL_CALC_FOUND_ROWS AgencyShipmentId, a.FundingSourceId, d.FundingSourceName, a.ShipmentStatusId, c.ShipmentStatusDesc, a.CountryId, 
            ...
            AND (a.CountryId = ".$CountryId." OR ".$CountryId." = 0) ".$AFundingSourceId." ".$ASStatusId. " " .$ItemGroup. "
			$sWhere 
            ORDER BY  CountryName asc, ShipmentDate desc 
            $sLimit";
     // ORDER BY  CountryName asc, ShipmentDate desc
            ...
            p {
              line-height: 0.5px;
                ...
                <body>
                    ...
                    <p style="text-align:center;"><h5><b>'.$gTEXT['Funding Source'].' : '.$FundingSourceName.',  '.$gTEXT['Status'].' : '.$ASStatusName.'</b><h5></p></br>
                    <p style="text-align:center;"><h5><b>'.$gTEXT['Product Group'].' : '.$ItemGroupName.' </b><h5><p>
                </body>';
    ...
    $html = '
        ...
        <body>
        <table width="600px" border="0.1" style="margin:0 auto;">
