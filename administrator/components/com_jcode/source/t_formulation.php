...
<div class="row"> 
	<div class="col-md-12">
		<div id="list-panel">
                <table  id="formulationTable" class="table table-striped table-bordered display table-hover" cellspacing="0">
                    <thead>
                        <tr>
							<th>Formulation Id</th>
							<th style="text-align: center;">SL.</th>
							<th><?php echo $TEXT['Formulation Type']; ?></th>
							<th><?php echo $TEXT['Formulation Type (French)']; ?></th>
							<th><?php echo $TEXT['Item Group']; ?></th>
            ...
            <div id="form-panel">
		        ...
		        <div class="panel-body">
		            <form novalidate="" data-validate="parsley" id="formulation_form" class="form-horizontal form-border no-margin">
		                ...
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="ServiceTypeId"><?php echo $TEXT['Service Type']; ?>*</label>
		                    <div class="col-md-8">
								<select class="form-control" name="ServiceTypeId" id="ServiceTypeId" data-required="true" >
		                ...
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="RegimenMasterName"><?php echo $TEXT['Formulation Name']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" maxlength="100" type="text" name="FormulationName" id="FormulationName" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
		                <div class="form-group">
		                    <label class="control-label col-md-4" for="FormulationNameFrench"><?php echo $TEXT['Formulation Name (French)']; ?>*</label>
		                    <div class="col-md-8">
		                        <input class="form-control input-sm parsley-validated" type="text" maxlength="200" name="FormulationNameFrench" id="FormulationNameFrench" data-required="true" placeholder="input here..."/>
		                    </div>
		                </div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div id="colorpicker3" class="input-group colorpicker-component colorpicker-element">
									<input class="form-control" maxlength="25" type="text" name="ColorCode" id="ColorCode" data-required="true" placeholder="input here..."/>
		                ...
		                <div class="form-group">
		                	<div class="col-md-4">
			                    <input type="text" value="insertUpdateFormulationData" id="action" name="action" style="display: none;"/>
 ...
 <script>
    ...
    function print_function(type) {
        var dataTableId = 'formulationTable';
		var reportSaveName = 'Formulation_Types'; //Not allow any type of special character of cahrtName
        ...
        var reportHeaderName = TEXT['Formulation Types List'];
        ...
        if (type == 'print') {
            window.open("<?php echo $baseUrl; ?>report/print_master.php?action=getformulationData"
            ...
            window.open("<?php echo $baseUrl; ?>report/excel_master.php?action=getformulationData"
                    + "&jBaseUrl=<?php echo $jBaseUrl; ?>"
                    + "&lan=<?php echo $lan; ?>"
                    + "&reportSaveName=" + reportSaveName
                    + "&sSearch=" + currentSearch
...
<style>
	#formulation_form select, #formulation_form input, #colorpicker3 input-group{
		max-width: 300px;
	}
	#colorpicker3 {
		max-width: 300px;
...
<script src='<?php echo $baseUrl; ?>t_formulation.js'></script>
