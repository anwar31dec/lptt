...
class PlgCaptchaRecaptcha extends JPlugin
{
	...
	{
		return '<div class="g-recaptcha" data-sitekey="6LfvHQATAAAAAAM0Jyx5fXSzYxl5iqLGiETpbfIl"></div>';
	}
		...
		if (!isset($response->success) || !$response->success){
			...
			foreach ($response->errorCodes as $error)
			{
				...
				/*if($error=='invalid-input-response')
					return true;
				else if($error=='missing-input-secret') $error='The secret parameter is missing.';
				else if($error=='invalid-input-secret') $error='The secret parameter is invalid or malformed.';
				else if($error=='missing-input-response') $error='The response parameter is missing.';*/
