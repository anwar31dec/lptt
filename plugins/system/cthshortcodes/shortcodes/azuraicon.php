...
//[Icon]
if(!function_exists('azuraicon_sc')) {

	function azuraicon_sc( $atts, $content="" ) {
		...
		if(stripos($layout, '_:') !== false){
			...
			if(stripos($layout, ':') !== false){
				...
				$shortcodeTemp = CthShortcodes::addShortcodeTemplate('azuraicon');
			}
		}
	...
	add_shortcode( 'AzuraIcon', 'azuraicon_sc' );
}