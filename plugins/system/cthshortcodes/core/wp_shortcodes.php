...
function do_shortcode_edit($content) {
    global $shortcode_tags;
    ...
    $pattern = get_shortcode_regex();
    return preg_replace_callback( "/$pattern/s", 'do_shortcode_edit_tag', $content );
}

function do_shortcode_edit_tag( $m ) {
    //global $shortcode_tags;
    ...
    $result['attrs'] = shortcode_parse_atts( $m[3] );
